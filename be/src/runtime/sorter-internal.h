...
#ifndef IMPALA_RUNTIME_SORTER_INTERNAL_H_
#define IMPALA_RUNTIME_SORTER_INTERNAL_H_
...
class Sorter::Run {
 ...
 private:
  ...
  /// Collect the non-null var-len (e.g. STRING) slots from 'src' in 'var_len_values'
  /// and return the total length of all var-len values in 'total_var_len'.
  ...
  /// StringValue ptrs in 'dest' to point to the copied data.
