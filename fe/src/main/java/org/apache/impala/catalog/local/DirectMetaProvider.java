...
class DirectMetaProvider implements MetaProvider {
  ...
  public Map<String, PartitionMetadata> loadPartitionsByRefs(
    ...
    for (Partition p: parts) {
      ...
      List<FileDescriptor> fds = loadFileMetadata(fullTableName, partName, p, hostIndex);
  ...
  private Map<String, PartitionMetadata> loadUnpartitionedPartition(
    ...
    List<FileDescriptor> fds = loadFileMetadata(table.dbName_ + "." + table.tableName_,
  ...
  private List<FileDescriptor> loadFileMetadata(String fullTableName, String partName,
  ...
  private static class PartitionMetadataImpl implements PartitionMetadata {
    ...
    public PartitionMetadataImpl(Partition msPartition, List<FileDescriptor> fds) {
