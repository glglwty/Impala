...
public class CatalogdMetaProvider implements MetaProvider {
  ...
  private static class TableMetaRefImpl implements TableMetaRef {
    ...
    /**
     *  Stash the HMS Table object since we need this in order to
     * handle some strange behavior whereby the catalogd returns a Partition with
     * no HMS partition object in the case of unpartitioned tables.
     */
