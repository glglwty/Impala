...
public class Analyzer {
  ...
  private static class GlobalState {
    ...
    boolean containsPercentile = false;
  ...
  boolean selectBlockContainsPercentile() { return containsPercentile; }
  boolean queryContainsPercentile() { return globalState_.containsPercentile; }
