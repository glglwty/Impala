...
public class StmtRewriter {
  ...
  public void rewrite(AnalysisResult analysisResult) throws AnalysisException {
    ...
    if (stmt instanceof QueryStmt) {
      ...
      throw new AnalysisException(
          "Unsupported statement containing subqueries: " + stmt.toSql());
    }
  ...
  void rewriteSelectStatementHook(SelectStmt stmt, Analyzer analyzer)
      throws AnalysisException {}
    ...
    private static Expr rewritePercentileExpr(PercentileAggExpr e,
      ...
      if (e.isDisc()) {
        ...
        return new FunctionCallExpr("_percentile_cont_interpolation", Lists
            .newArrayList(e.orderByExpr().substituteImpl(toRedirectSlotRef),
                childSlotRef));
      }
    }

    @Override
    protected void rewriteSelectStatementHook(SelectStmt stmt, Analyzer analyzer) {
